...
@app.route("/get_war/<string:projectid>/<string:startdate>", methods=["GET"])
def get_war(projectid, startdate):
    with db.session() as session:
        war = session.query(War).filter_by(projectid=projectid).first()
